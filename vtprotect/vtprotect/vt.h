...
#define	PML4_BASE	0xFFFFF6FB7DBED000 // Corresponding to the four constants in the Windows kernel
...
typedef struct _DEBUG_DR6_
{
	...
	unsigned B0 : 1;// Dr0 breakpoint access
	unsigned B1 : 1;// Dr1 breakpoint access
	unsigned B2 : 1;// Dr2 breakpoint access
	unsigned B3 : 1;// Dr3 breakpoint access
	unsigned Reverted : 9;
	unsigned BD : 1;// DB exception caused by debug register access
	unsigned BS : 1;// DB exception caused by single-step
	unsigned BT : 1;// DB exception caused by task switch
...
typedef struct _DEBUG_DR7_
{
	...
	unsigned L0 : 1; // 0 DR0 breakpoint #DB
	unsigned G0 : 1; // 1
	unsigned L1 : 1; // 2 DR1 breakpoint#DB
	unsigned G1 : 1; // 3
	unsigned L2 : 1; // 4 DR2 breakpoint#DB
	unsigned G2 : 1; // 5
	unsigned L3 : 1; // 6 DR3 breakpoint#DB
	unsigned G3 : 1; // 7
	unsigned LE : 1; // 8
	unsigned GE : 1; // 9
	unsigned reserved : 3; //001  //10-11-12
	unsigned GD : 1; // 13...Allow DB exception for debug register access
	unsigned reserved2 : 2; //00
	unsigned RW0 : 2;// Set DR0 access type
	unsigned LEN0 : 2;// Set DR0 byte length
	unsigned RW1 : 2;// Set DR1 access type
	unsigned LEN1 : 2;// Set DR1 byte length
	unsigned RW2 : 2;// Set DR2 access type
	unsigned LEN2 : 2;// Set DR2 byte length
	unsigned RW3 : 2;// Set DR3 access type
	unsigned LEN3 : 2;// Set DR3 byte length
